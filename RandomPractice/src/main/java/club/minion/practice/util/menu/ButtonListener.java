package club.minion.practice.util.menu;

import club.minion.practice.Practice;
import club.minion.practice.util.menu.pagination.PaginatedMenu;
...
public class ButtonListener implements Listener {
	...
	public void onInventoryClose(InventoryCloseEvent event) {
		...
		player.setMetadata("scanglitch", new FixedMetadataValue(Practice.getInstance(), true));
	}
	...
	public void onPlayerMove(PlayerMoveEvent event) {
		...
		if (player.hasMetadata("scanglitch")) {
			player.removeMetadata("scanglitch", Practice.getInstance());
