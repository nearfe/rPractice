...
/**
 * Highly efficient version of the ${@link org.bukkit.Location} class.
...
public class CustomLocation {
	...
	public World toBukkitWorld() {
		if (this.world == null) {
			return CorePlugin.getInstance().getServer().getWorlds().get(0);
		} else {
			return CorePlugin.getInstance().getServer().getWorld(this.world);
		}
	}
