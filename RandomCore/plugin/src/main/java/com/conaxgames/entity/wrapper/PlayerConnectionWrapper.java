...
public class PlayerConnectionWrapper extends PlayerConnection {

	private boolean disconnected = false;

	public PlayerConnectionWrapper(MinecraftServer minecraftserver, NetworkManager networkmanager, EntityPlayer entityplayer) {
